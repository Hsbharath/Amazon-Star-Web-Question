...
var starList = document.querySelectorAll(".box");
var selectedStars = -1;
...
function starClick(ev) {
  var clicked = ev.currentTarget.starValue;
  selectedStars = clicked;
  starList.forEach(function (star, index) {
...
function starFocus(ev) {
  var focus = ev.currentTarget.starValue;
  starList.forEach(function (star, index) {
...
function starBlur(ev) {
  var blur = ev.currentTarget.starValue;
  starList.forEach(function (star, index) {
